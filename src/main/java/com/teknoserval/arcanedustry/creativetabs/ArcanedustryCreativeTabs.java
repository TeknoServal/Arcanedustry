...
public class ArcanedustryCreativeTabs {
    ...
    public static final Multimap<String, DeferredItem<? extends Item>> TAB_ITEM_LOCATIONS = ArrayListMultimap.create();
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register(EXAMPLE_TAB_ID, () -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                for (DeferredItem<? extends Item> item : TAB_ITEM_LOCATIONS.get(EXAMPLE_TAB_ID)) {
